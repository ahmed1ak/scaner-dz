...
./inurlbr.php {$_SESSION["c1"]}--dork {$_SESSION["c2"]}'sw_comment.php?id=il' {$_SESSION["c1"]}-s {$_SESSION["c2"]}save.txt {$_SESSION["c1"]}-q 1,6 {$_SESSION["c1"]}-t {$_SESSION["c2"]}1 {$_SESSION["c1"]}--exploit-get {$_SESSION["c3"]}\"?´'%270x27;\" {$_SESSION["c0"]} 
...
function __bannerLogo() {
    ...
    return (!is_null($_SESSION['config']['no-banner']) ? NULL : system("command clear") . "
     ...
     (_)[___]{}<________|-\IIIIII/-|__hmidax01__hmidax01__hmidax01__________\    
       /     )_/        \          /                               
                         \ ______ /


{$_SESSION["c1"]}__[ ! ] hello by hmidax01  2021  
...
{$_SESSION["c1"]}__[ ! ] {$_SESSION["c2"]}Help: php scaner.php --help {$_SESSION["c0"]} 
{$_SESSION["c1"]}------------------------------------------------------------------------------------------------------------------------{$_SESSION["c0"]}
");
}
